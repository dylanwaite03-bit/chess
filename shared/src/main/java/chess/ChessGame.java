...
public class ChessGame {
    ...
    private void addCastlingMoves(ChessPosition startPosition,
                                  ChessPiece piece,
    ...
    private boolean canCastleRight(int row, ChessPiece piece) {
    ...
    private boolean canCastleLeft(int row, ChessPiece piece) {
